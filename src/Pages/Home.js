  ...
  <List className='text-black'>
    ...
    <div className='w-full flex justify-center items-center flex-wrap mt-10 gap-5'>
      ...
      <div className='w-full flex mt-20 flex-wrap justify-center gap-8 2xl:gap-0'>
        ...
        <div id='left' className='w-11/12  lg:w-9/12 2xl:w-1/2  flex justify-center '>

          <div className='w-11/12 lg:w-10/12 bg-slate-200 xl:w-9/12 '>
          ...
          <div className='w-full flex flex-col justify-center items-center gap-6 '>
            <div className='flex gap-5 py-8 shadow-md bg-white p-6 border w-11/12 rounded-xl mt-6'> <img src={Vector} alt="" /> <p>Clarification With Regard To Operation Of Wait List </p> </div>
            <div className='flex gap-5 py-8 shadow-md bg-white p-6 border w-11/12 rounded-xl'> <img src={Vector} alt="" /> <p>BPR&D New Criminal Laws</p> </div>
            <div className='flex gap-5 py-8 shadow-md bg-white p-6 border w-11/12 rounded-xl'> <img src={Vector} alt="" /> <p>Clarification With Regard To Operation Of Wait List </p> </div>
            <div className='flex gap-5 py-8 shadow-md bg-white p-6 border w-11/12 rounded-xl'> <img src={Vector} alt="" /> <p>BPR&D New Criminal Laws</p> </div>
            <div className='flex gap-5 py-8 shadow-md bg-white p-6 border w-11/12 rounded-xl'> <img src={Vector} alt="" /> <p>Clarification With Regard To Operation Of Wait List</p> </div>
            <div className='flex gap-5 py-8 shadow-md bg-white p-6 border w-11/12 rounded-xl mb-6'> <img src={Vector} alt="" /> <p>BPR&D New Criminal Laws</p> </div>
          </div>
            </div>
        </div>
        <div id='right' className='flex gap-5 sm:gap-8 lg:gap-4 flex-wrap w-11/12 lg:w-w-10/12 2xl:w-1/2 lg:gap-8 2xl:gap-16 justify-center'>
          <img src={News1} alt="" />
          <img src={News2} alt="" />
          <img src={News3} alt="" />
          <img src={News4} alt="" />
